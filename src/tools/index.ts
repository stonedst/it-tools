...
import { tool as watermarker } from './watermarker';
...
export const toolsByCategory: ToolCategory[] = [
  ...
  {
    name: 'Network',
    components: [ipv4SubnetCalculator, ipv4AddressConverter, ipv4RangeExpander, macAddressLookup, macAddressGenerator, ipv6UlaGenerator, dnsQueries],
  },
  {
    name: 'Math',
